export const posts = [
  ...
  },
  {
    ...
    category: "Research",
    status: "cooking",
    excerpt: "The bookkeeping discipline behind running concurrent paper projects: every number traces to a scorer version and run, kill criteria precede spend, expensive runs pass a gate, logs are append-only, and no detector output is believed before a manual audit.",
