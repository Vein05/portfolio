...
When an order status was replaced with a value outside the valid set, the monitor helped sharply: Flash rose from 6/50 to 20/50, a 28-point gain with 14 paired wins and no losses. When a payment-conservation relationship was corrupted, Flash completed 35/50 tasks with or without the monitor. There were nine rescues and nine harms, producing no net effect.
...
## Detection falls to 46% outside the learned rule classes
