...
import Image from "../images/image.jpg"   
  export default function Example() {
    return (
      <Card color="transparent" shadow={false} className="w-full max-w-[26rem] p-2 border-2 border-dashed border-blue-500 rounded">
        <CardHeader
          color="transparent"
          floated={false}
          shadow={false}
          className="mx-0 flex items-center justify-center gap-4 pt-0 pb-8"
        >
          <Avatar
            size="lg"
            src={Image}
          ...
          <div className="flex w-full flex-col gap-0.5">
            ...
            <Typography color="blue-gray">@Self-Taught Developer </Typography>
          </div>
        </CardHeader>
